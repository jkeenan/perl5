...
TK: Details on how to run F<make test> over selected files or directories.

TK: Details on summary information (especially for failures) presented by
F<make test>.

Upon success, F<make test> will print a short summary to STDOUT.  Example:
...
Upon success, F<make test_harness> will print a short summary to STDOUT.
